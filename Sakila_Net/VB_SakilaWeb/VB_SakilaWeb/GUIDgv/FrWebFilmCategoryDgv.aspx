<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrWebFilmCategoryDgv.aspx.vb" Inherits="VB_SakilaWeb.FrWebFilmCategoryDgv" %>
        ...
        <div class="container span10 col-sm-7" >
			<div class="tab-content span10">
			    <div class="tab-pane active" id="tab_Empe">
					<div class="LoginDiv">
					    <fieldset>
					        <legend>Registros de FilmCategory</legend>
...
<asp:BoundField DataField="category_id" FooterText="CategoryId" HeaderText="CategoryId" />
