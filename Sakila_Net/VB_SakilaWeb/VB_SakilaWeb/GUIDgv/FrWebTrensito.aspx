<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrWebTrensito.aspx.vb" Inherits="VB_SakilaWeb.FrWebTrensito" %>
        ...
        <div class="container span10 col-sm-7" >
			<div class="tab-content span10">
			    <div class="tab-pane active" id="tab_Empe">
					<div class="LoginDiv">
					    <fieldset>
					        <legend>Mantenedor Trensito</legend>
				        ...
				        <asp:textbox  Enabled="False" ID="TxtNombre" runat="server" AutoPostBack="False" CssClass="cssTxt" MaxLength="50" Width="750px"></asp:textbox>
					            ...
					            <div style="padding: 5px"  class="form-group">
					                <label class="col-sm-3 control-label" ><asp:Label ID="lbLargo" runat="server" Text="Largo"></asp:Label></label>
				                       <div class="col-sm-3">
				        <asp:textbox  Enabled="False" ID="TxtLargo" runat="server" AutoPostBack="False" CssClass="cssNum" MaxLength="10" Width="150px"></asp:textbox>
				                       </div>
					            </div>
					            <div style="padding: 5px"  class="form-group">
					                <label class="col-sm-3 control-label" ><asp:Label ID="lbIdMarca" runat="server" Text="IdMarca"></asp:Label></label>
				                       <div class="col-sm-3">
				        <asp:textbox  Enabled="False" ID="TxtIdMarca" runat="server" AutoPostBack="False" CssClass="cssNum" MaxLength="11" Width="165px"></asp:textbox>
				                       </div>
					            </div>
