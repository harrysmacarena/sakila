<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrWebCountryDgv.aspx.vb" Inherits="VB_SakilaWeb.FrWebCountryDgv" %>
        ...
        <div class="container span10 col-sm-7" >
			<div class="tab-content span10">
			    <div class="tab-pane active" id="tab_Empe">
					<div class="LoginDiv">
					    <fieldset>
					        <legend>Registros de Country</legend>
					        <div style="text-align: left;">
    <asp:GridView ID="GdData" runat="server" AutoGenerateColumns="False">
        <Columns>
<asp:BoundField DataField="country_id" FooterText="CountryId" HeaderText="CountryId" />
<asp:BoundField DataField="country" FooterText="Country" HeaderText="Country" />
