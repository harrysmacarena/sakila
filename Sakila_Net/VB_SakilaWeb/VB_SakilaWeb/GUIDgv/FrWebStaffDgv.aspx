<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrWebStaffDgv.aspx.vb" Inherits="VB_SakilaWeb.FrWebStaffDgv" %>
        ...
        <div class="container span10 col-sm-7" >
			<div class="tab-content span10">
			    <div class="tab-pane active" id="tab_Empe">
					<div class="LoginDiv">
					    <fieldset>
					        <legend>Registros de Staff</legend>
...
<asp:BoundField DataField="first_name" FooterText="FirstName" HeaderText="FirstName" />
<asp:BoundField DataField="last_name" FooterText="LastName" HeaderText="LastName" />
<asp:BoundField DataField="address_id" FooterText="AddressId" HeaderText="AddressId" />
<asp:BoundField DataField="picture" FooterText="Picture" HeaderText="Picture" />
...
<asp:BoundField DataField="active" FooterText="Active" HeaderText="Active" />
<asp:BoundField DataField="username" FooterText="Username" HeaderText="Username" />
<asp:BoundField DataField="password" FooterText="Password" HeaderText="Password" />
