...
Public Class FrmRentalLsb
    ...
    Private Sub  ListarData()
        ...
        'dgvData.SetSelected(5, True)
          ...
          Me.dgvData.DisplayMember = "rental_date"
        Me.dgvData.ValueMember = "rental_id"

        Dim dt As DataTable = ClNegRental.listar(1,100)
    ...
    Private Sub ListarDataClass()
        ...
        For Each xrow As DataRow In dt.Rows
            dataClass.Add(New ClRental(
xrow("rental_id") _
,xrow("rental_date") _
,New ClInventory(xrow("inventory_id")) _
