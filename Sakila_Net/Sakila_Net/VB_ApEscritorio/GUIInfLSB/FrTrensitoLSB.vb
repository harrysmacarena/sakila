...
Public Class FrmTrensitoLsb
    ...
    Private Sub  ListarData()
        ...
        'dgvData.SetSelected(5, True)
          ...
          Me.dgvData.DisplayMember = "nombre"
        Me.dgvData.ValueMember = "Id"

        Dim dt As DataTable = ClNegTrensito.listar(1,100)
