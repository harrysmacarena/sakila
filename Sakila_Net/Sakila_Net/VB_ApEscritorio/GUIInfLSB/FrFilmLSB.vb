...
Public Class FrmFilmLsb
    ...
    Private Sub  ListarData()
        ...
        Dim dt As DataTable = ClNegFilm.listar(1,100)
    ...
    Private Sub ListarDataClass()
        ...
        For Each xrow As DataRow In dt.Rows
            dataClass.Add(New ClFilm(
xrow("film_id") _
,xrow("title") _
,xrow("description") _
,xrow("release_year") _
,New ClLanguage(xrow("language_id")) _
,xrow("original_language_id") _
,xrow("rental_duration") _
,xrow("rental_rate") _
,xrow("length") _
,xrow("replacement_cost") _
,xrow("rating") _
,xrow("special_features") _
,xrow("last_update") _
                                      ))
        Next
