...
''        Me.dgvData.ValueMember = "New ClActor(Integer.Parse(actorId")
''        Me.dgvData.ValueMember = "New ClFilm(Integer.Parse(filmId")

        Dim dt As DataTable = ClNegFilmActor.listar(1,100)
    ...
    Private Sub ListarDataClass()
        ...
        For Each xrow As DataRow In dt.Rows
            dataClass.Add(New ClFilmActor(
New ClActor(xrow("actor_id")) _
