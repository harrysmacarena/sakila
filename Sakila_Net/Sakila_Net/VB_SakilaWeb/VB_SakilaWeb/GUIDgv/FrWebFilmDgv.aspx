<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrWebFilmDgv.aspx.vb" Inherits="VB_SakilaWeb.FrWebFilmDgv" %>
        ...
        <div class="container span10 col-sm-7" >
			<div class="tab-content span10">
			    <div class="tab-pane active" id="tab_Empe">
					<div class="LoginDiv">
					    <fieldset>
					        <legend>Registros de Film</legend>
					        <div style="text-align: left;">
    <asp:GridView ID="GdData" runat="server" AutoGenerateColumns="False">
        <Columns>
<asp:BoundField DataField="film_id" FooterText="FilmId" HeaderText="FilmId" />
<asp:BoundField DataField="title" FooterText="Title" HeaderText="Title" />
<asp:BoundField DataField="description" FooterText="Description" HeaderText="Description" />
<asp:BoundField DataField="release_year" FooterText="ReleaseYear" HeaderText="ReleaseYear" />
<asp:BoundField DataField="language_id" FooterText="LanguageId" HeaderText="LanguageId" />
<asp:BoundField DataField="original_language_id" FooterText="OriginalLanguageId" HeaderText="OriginalLanguageId" />
<asp:BoundField DataField="rental_duration" FooterText="RentalDuration" HeaderText="RentalDuration" />
<asp:BoundField DataField="rental_rate" FooterText="RentalRate" HeaderText="RentalRate" />
<asp:BoundField DataField="length" FooterText="Length" HeaderText="Length" />
<asp:BoundField DataField="replacement_cost" FooterText="ReplacementCost" HeaderText="ReplacementCost" />
<asp:BoundField DataField="rating" FooterText="Rating" HeaderText="Rating" />
<asp:BoundField DataField="special_features" FooterText="SpecialFeatures" HeaderText="SpecialFeatures" />
