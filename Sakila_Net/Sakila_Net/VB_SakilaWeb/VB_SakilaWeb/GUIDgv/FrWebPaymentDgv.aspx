<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrWebPaymentDgv.aspx.vb" Inherits="VB_SakilaWeb.FrWebPaymentDgv" %>
        ...
        <div class="container span10 col-sm-7" >
			<div class="tab-content span10">
			    <div class="tab-pane active" id="tab_Empe">
					<div class="LoginDiv">
					    <fieldset>
					        <legend>Registros de Payment</legend>
					        <div style="text-align: left;">
    <asp:GridView ID="GdData" runat="server" AutoGenerateColumns="False">
        <Columns>
<asp:BoundField DataField="payment_id" FooterText="PaymentId" HeaderText="PaymentId" />
...
<asp:BoundField DataField="amount" FooterText="Amount" HeaderText="Amount" />
<asp:BoundField DataField="payment_date" FooterText="PaymentDate" HeaderText="PaymentDate" />
