<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrWebCustomerDgv.aspx.vb" Inherits="VB_SakilaWeb.FrWebCustomerDgv" %>
        ...
        <div class="container span10 col-sm-7" >
			<div class="tab-content span10">
			    <div class="tab-pane active" id="tab_Empe">
					<div class="LoginDiv">
					    <fieldset>
					        <legend>Registros de Customer</legend>
...
<asp:BoundField DataField="create_date" FooterText="CreateDate" HeaderText="CreateDate" />
