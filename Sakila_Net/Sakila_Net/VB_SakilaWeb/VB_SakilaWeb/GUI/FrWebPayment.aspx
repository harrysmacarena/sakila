<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrWebPayment.aspx.vb" Inherits="VB_SakilaWeb.FrWebPayment" %>
        ...
        <div class="container span10 col-sm-7" >
			<div class="tab-content span10">
			    <div class="tab-pane active" id="tab_Empe">
					<div class="LoginDiv">
					    <fieldset>
					        <legend>Mantenedor Payment</legend>
					        <div style="text-align: left;">
					            <div style="padding: 5px"  class="form-group">
					                <label class="col-sm-3 control-label" ><asp:Label ID="lbPaymentId" runat="server" Text="PaymentId"></asp:Label></label>
				                       <div class="col-sm-3">
				        <asp:textbox  Enabled="True" ID="TxtPaymentId" runat="server" AutoPostBack="False" CssClass="cssNum" MaxLength="5" Width="75px"></asp:textbox>
				                       </div>
					            </div>
					            <div style="padding: 5px"  class="form-group">
				        ...
				        <asp:DropDownList  Enabled="False" ID="ddStaffId" runat="server" Height="26px" Width="504px"></asp:DropDownList>
					            ...
					            <div style="padding: 5px"  class="form-group">
					                <label class="col-sm-3 control-label" ><asp:Label ID="lbRentalId" runat="server" Text="RentalId"></asp:Label></label>
				                       <div class="col-sm-3">
				        <asp:DropDownList  Enabled="False" ID="ddRentalId" runat="server" Height="26px" Width="504px"></asp:DropDownList>
				                       </div>
					            </div>
					            <div style="padding: 5px"  class="form-group">
					                <label class="col-sm-3 control-label" ><asp:Label ID="lbAmount" runat="server" Text="Amount"></asp:Label></label>
				                       <div class="col-sm-3">
				        <asp:textbox  Enabled="False" ID="TxtAmount" runat="server" AutoPostBack="False" CssClass="cssNum" MaxLength="5" Width="78px"></asp:textbox>        
				                       </div>
					            </div>
					            <div style="padding: 5px"  class="form-group">
					                <label class="col-sm-3 control-label" ><asp:Label ID="lbPaymentDate" runat="server" Text="PaymentDate"></asp:Label></label>
				                       <div class="col-sm-3">
				        <asp:TemplateField HeaderText="Birth Date"><ItemTemplate><asp:Textbox Enabled="False" ID="cldLbPaymentDateLabel" Runat="Server" Text='<%# Eval("DatePaymentDate", "{0:d}") %>' /></ItemTemplate><EditItemTemplate><asp:Calendar  Enabled="False" ID="cldPaymentDate" runat="server" AutoPostBack="False" CssClass="cssFYH" MaxLength="20" Width="300px" SelectionMode="Day" ShowGridLines="True" VisibleDate='<%# Eval("DatePaymentDate") %>'  SelectedDate='<%# Bind("DatePaymentDate") %>'></asp:Calendar></EditItemTemplate></asp:TemplateField> 
				                       </div>
					            </div>
					            <div style="padding: 5px"  class="form-group">
