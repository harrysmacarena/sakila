...
Public Class FrmPaymentLsb
 ...
 ''         New ClCustomer(Integer.Parse(customerId")
        Me.dgvData.ValueMember = "payment_id"

        Dim dt As DataTable = ClNegPayment.listar(1,100)
    ...
    Private Sub ListarDataClass()
        ...
        For Each xrow As DataRow In dt.Rows
            dataClass.Add(New ClPayment(
xrow("payment_id") _
,New ClCustomer(xrow("customer_id")) _
,New ClStaff(xrow("staff_id")) _
,New ClRental(xrow("rental_id")) _
,xrow("amount") _
,xrow("payment_date") _
,xrow("last_update") _
                                      ))
