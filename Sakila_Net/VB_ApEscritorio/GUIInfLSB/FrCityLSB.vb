...
Public Class FrmCityLsb
    ...
    Private Sub  ListarData()
        ...
        'dgvData.SetSelected(5, True)
          ...
          Me.dgvData.DisplayMember = "city"
        Me.dgvData.ValueMember = "city_id"

        Dim dt As DataTable = ClNegCity.listar(1,100)
    ...
    Private Sub ListarDataClass()
        ...
        For Each xrow As DataRow In dt.Rows
            dataClass.Add(New ClCity(
xrow("city_id") _
,xrow("city") _
,New ClCountry(xrow("country_id")) _
,xrow("last_update") _
                                      ))
        Next
