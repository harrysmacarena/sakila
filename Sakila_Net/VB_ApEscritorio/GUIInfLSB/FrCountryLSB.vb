...
Public Class FrmCountryLsb
    ...
    Private Sub  ListarData()
        ...
        'dgvData.SetSelected(5, True)
          ...
          Me.dgvData.DisplayMember = "country"
        Me.dgvData.ValueMember = "country_id"

        Dim dt As DataTable = ClNegCountry.listar(1,100)
