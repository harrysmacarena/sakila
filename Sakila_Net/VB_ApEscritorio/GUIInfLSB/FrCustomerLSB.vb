...
Public Class FrmCustomerLsb
 ...
 ''         New ClStore(Integer.Parse(storeId")
        Me.dgvData.ValueMember = "customer_id"

        Dim dt As DataTable = ClNegCustomer.listar(1,100)
