...
Public Class FrmLanguageLsb
    ...
    Private Sub  ListarData()
        ...
        'dgvData.SetSelected(5, True)
          ...
          Me.dgvData.DisplayMember = "name"
        Me.dgvData.ValueMember = "language_id"

        Dim dt As DataTable = ClNegLanguage.listar(1,100)
