...
<div class='row-fluid'>
	...
	<form class='form-vertical well-large' id='forms-XXX'>
		...
		<div class='box-content nopadding'>
			...
			<thead>
				<tr class='colhead'>
<td>StaffId</td><td>FirstName</td><td>LastName</td><td>AddressId</td><td>Picture</td><td>Email</td><td>StoreId</td><td>Active</td><td>Username</td><td>Password</td><td>LastUpdate</td>				</tr>
			</thead>
<?PHP			
   $arrDatos = staffDAO::sqlSelectTodo();
