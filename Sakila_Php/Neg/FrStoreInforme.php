...
<div class='row-fluid'>
	...
	<form class='form-vertical well-large' id='forms-XXX'>
		...
		<div class='box-content nopadding'>
			...
			<thead>
				<tr class='colhead'>
<td>StoreId</td><td>ManagerStaffId</td><td>AddressId</td><td>LastUpdate</td>				</tr>
			</thead>
<?PHP			
   $arrDatos = storeDAO::sqlSelectTodo();
   foreach ($arrDatos as  $linea){
?>   
             <tr class='evenrow'>

<td><?PHP echo $linea['store_id']; ?></td>
<td><?PHP echo $linea['manager_staff_id']; ?></td>
