...
<div class='row-fluid'>
	...
	<form class='form-vertical well-large' id='forms-XXX'>
		...
		<div class='box-content nopadding'>
			...
			<thead>
				<tr class='colhead'>
<td>CityId</td><td>City</td><td>CountryId</td><td>LastUpdate</td>				</tr>
			</thead>
<?PHP			
   $arrDatos = cityDAO::sqlSelectTodo();
   foreach ($arrDatos as  $linea){
?>   
             <tr class='evenrow'>

<td><?PHP echo $linea['city_id']; ?></td>
<td><?PHP echo $linea['city']; ?></td>
<td><?PHP echo $linea['country_id']; ?></td>
