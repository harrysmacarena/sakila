	...
	<form class='form-vertical well-large' id='forms-XXX'>
		<div class='box-title'>
			<table id='tblTitulo' class='table'>
				  <tr><th><h4>Datos de  Payment</h4></th>
		...
		<div class='box-content nopadding'>
			...
			<thead>
				<tr class='colhead'>
<td>PaymentId</td><td>CustomerId</td><td>StaffId</td><td>RentalId</td><td>Amount</td><td>PaymentDate</td><td>LastUpdate</td>				</tr>
			</thead>
<?PHP			
   $arrDatos = paymentDAO::sqlSelectTodo();
   foreach ($arrDatos as  $linea){
?>   
             <tr class='evenrow'>

<td><?PHP echo $linea['payment_id']; ?></td>
<td><?PHP echo $linea['customer_id']; ?></td>
<td><?PHP echo $linea['staff_id']; ?></td>
<td><?PHP echo $linea['rental_id']; ?></td>
<td><?PHP echo $linea['amount']; ?></td>
<td><?PHP echo $linea['payment_date']; ?></td>
