	...
	<form class='form-vertical well-large' id='forms-XXX'>
		<div class='box-title'>
			<table id='tblTitulo' class='table'>
				  <tr><th><h4>Datos de  FilmCategory</h4></th>
		...
		<div class='box-content nopadding'>
			...
			<thead>
				<tr class='colhead'>
<td>FilmId</td><td>CategoryId</td><td>LastUpdate</td>				</tr>
			</thead>
<?PHP			
   $arrDatos = filmCategoryDAO::sqlSelectTodo();
   foreach ($arrDatos as  $linea){
?>   
             <tr class='evenrow'>

<td><?PHP echo $linea['film_id']; ?></td>
<td><?PHP echo $linea['category_id']; ?></td>
